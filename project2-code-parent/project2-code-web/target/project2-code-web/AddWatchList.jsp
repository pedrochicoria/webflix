...
<div class="container">
    ...
    <h2 style="color: red;font-size: 30px">WatchLists</h2>
    <% List<Content> allContent = (List<Content>) request.getSession().getAttribute("allContent");
    ...
    <table style="color: #f1f1f1">
        ...
        <td style="color: #f1f1f1">
            <form method="post">
                <input type="hidden" name="addcontent" value="<%out.print(c.getTitle());%>">
                <button style="background-color: #222;color: white;border-color: #222" class="btn btn-danger navbar-btn"
                        name="action" value="addtowatchlist"><% out.println(c.getTitle()); %>
                </button>
            </form>
        </td>

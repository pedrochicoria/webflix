...
<div class="container">
    ...
    <div id="left" style="float:left; width:100%;" align="center">
        <h3 style="color:red">Edit Credit Card Number</h3>
        <form method="post" style="color: red;">
            New Credit Card Number<br> <input style="color: black" type="text"
                                              placeholder="Enter new credit card number" name="credit_card_number"
                                              required>
            <br>
            <input type="hidden" name="action" value="changecard">
            <button type="submit" class="registerbtn">Change credit card number</button>
        </form>

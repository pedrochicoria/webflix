...
<div class="container">
    ...
    <div id="left" style="float:left; width:100%;" align="center">
        <h3 style="color:red">Edit Name</h3>
        <form method="post" style="color: red;">
            New name<br> <input style="color: black" type="text" placeholder="Enter new name" name="name" required>
            <br>
            <input type="hidden" name="action" value="changename">
            <button type="submit" class="registerbtn">Change Name</button>
        </form>

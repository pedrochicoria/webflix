...
<div class="container">
    ...
    <h2 style="color: red;font-size: 30px">Search Content by Years</h2>
    ...
    <table style="color: #f1f1f1">
        ...
        <tr>
            <td style="color: #f1f1f1">${content.title}</td>
            <td style="color: #f1f1f1">${content.category}</td>
            <td style="color: #f1f1f1">${content.director}</td>
            <td style="color: #f1f1f1">${content.year}</td>

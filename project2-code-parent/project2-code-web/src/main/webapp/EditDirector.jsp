...
<div class="container">
    ...
    <div id="left" style="float:left; width:100%;" align="center">
        <h3 style="color:red">Edit Director</h3>
        <form method="post" style="color: red">
            ...
            <br><br>
            Director <br>
            <input style="color: black" type="text" placeholder="Enter new director" name="director" required>
            <br><br>
            <input type="hidden" name="action" value="changedirector">
            <button type="submit" class="registerbtn">Change director</button>

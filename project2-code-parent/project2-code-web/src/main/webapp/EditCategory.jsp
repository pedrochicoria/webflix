...
<div class="container">
    ...
    <div id="left" style="float:left; width:100%;" align="center">
        ...
        <form method="post" style="color: red">
            ...
            <br><br>
            New Category <br><select style="color: black" type="text" placeholder="Select new category" name="category">
            ...
            <button type="submit" class="registerbtn">Change category</button>
        </select>
        </form>
    </div>

...
<div class="container">
    ...
    <div id="left" style="float:left; width:100%;" align="center">
        <h3 style="color:red">Edit username</h3>
        <form method="post" style="color: red;">
            New password<br> <input style="color: black" type="text" placeholder="Enter new username" name="username"
                                    required>
            <br>
            <input type="hidden" name="action" value="changeusername">
            <button type="submit" class="registerbtn">Change Username</button>
        </form>

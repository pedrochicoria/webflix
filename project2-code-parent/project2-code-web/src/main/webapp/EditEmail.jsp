...
<div class="container">
    ...
    <div id="left" style="float:left; width:100%;" align="center">
        <h3 style="color:red">Edit Email</h3>
        <form method="post" style="color: red;">
            New Email<br> <input style="color: black" type="text" placeholder="Enter new e-mail" name="email" required>
            <br>
            <input type="hidden" name="action" value="changeemail">
            <button type="submit" class="registerbtn">Change Email</button>
        </form>

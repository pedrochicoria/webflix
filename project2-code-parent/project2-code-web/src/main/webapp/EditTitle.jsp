...
<div class="container">
        ...
        <div class="container-fluid">
            ...
            <ul class="nav navbar-nav navbar-right">
                <form method="post">
                    ...
                    <button class="btn btn-danger navbar-btn"style="width: 100%"><span class="glyphicon glyphicon-log-out"></span> Logout
                    </button>
                </form>
            </ul>
    ...
    <div id="left" style="float:left; width:100%;" align="center">
        <h3 style="color:red">Edit Title</h3>
        <form method="post" style="color: red">
            ...
            <br><br>
            Title <br>
            <input style="color: black" type="text" placeholder="Enter new title" name="title" required>
            <br><br>
            <input type="hidden" name="action" value="changetitle">
            <button type="submit" class="registerbtn">Change Title</button>
